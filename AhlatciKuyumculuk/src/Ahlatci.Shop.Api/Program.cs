using AhlatciKuyumculuk.Shop.Api.Filters;
using AhlatciKuyumculuk.Shop.Application.Automappings;
using AhlatciKuyumculuk.Shop.Application.Repositories;
using AhlatciKuyumculuk.Shop.Application.Services.Abstraction;
using AhlatciKuyumculuk.Shop.Application.Services.Implementation;
using AhlatciKuyumculuk.Shop.Application.Validators.Categories;
using AhlatciKuyumculuk.Shop.Domain.Services.Abstraction;
using AhlatciKuyumculuk.Shop.Domain.Services.Implementation;
using AhlatciKuyumculuk.Shop.Domain.UWork;
using AhlatciKuyumculuk.Shop.Persistence.Context;
using AhlatciKuyumculuk.Shop.Persistence.Repositories;
using AhlatciKuyumculuk.Shop.Persistence.UWork;
